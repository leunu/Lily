...
void calculateLineFollowingTermFlip(void){
	...
	if(line_trace_enable_flag == 1){
		...
		diff = ( ( Linesensor[0] + Linesensor[1] + Linesensor[2] + Linesensor[3] + Linesensor[4] + Linesensor[5] + Linesensor[6] + Linesensor[7]) / 8 ) - ( ( Linesensor[8] + Linesensor[9] + Linesensor[10] + Linesensor[11] + Linesensor[12] + Linesensor[13] + Linesensor[14] + Linesensor[15]) / 8 );
