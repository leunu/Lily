...
#define FLED_B_Pin GPIO_PIN_11
#define FLED_B_GPIO_Port GPIOC
#define FLED_G_Pin GPIO_PIN_12
#define FLED_G_GPIO_Port GPIOC
#define FLED_R_Pin GPIO_PIN_2
#define FLED_R_GPIO_Port GPIOD
#define Encorder_L1_Pin GPIO_PIN_4
#define Encorder_L1_GPIO_Port GPIOB
#define Encorder_L2_Pin GPIO_PIN_5
#define Encorder_L2_GPIO_Port GPIOB
#define Encorder_R1_Pin GPIO_PIN_6
#define Encorder_R1_GPIO_Port GPIOB
#define Encorder_R2_Pin GPIO_PIN_7
#define Encorder_R2_GPIO_Port GPIOB
